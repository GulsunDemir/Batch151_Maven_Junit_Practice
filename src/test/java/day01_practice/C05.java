...
public class C05 {
    ...
    public void test01() throws InterruptedException {
        ...
        List<WebElement> urunlerinlinkleri = driver.findElements(By.xpath("//a[@class='a-link-normal s-underline-text s-underline-link-text s-link-style a-text-normal']"));
